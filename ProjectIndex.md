...
| [ZOHO AI Assistant](./projects/ZOHO AI Assistant) | AI-driven assistant for Zoho CRM automating workflows and communications | - Integration with Zoho CRM<br>- Natural language query processing<br>- Automated email and task management | JavaScript, Deluge | - Handling Zoho API authentication and rate limits |
|--------------|-------------|--------------|----------------------|------------------------|  
